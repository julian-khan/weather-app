...
export default function LocationForm({setLocationName}) {
   ...
   <form onSubmit={handleSubmit}>
            <label for="citySearch" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-gray-300">
            Search for a city:  
            </label>
            <input id="citySearch" type="text" value={formValue} onChange={handleChange}/>
