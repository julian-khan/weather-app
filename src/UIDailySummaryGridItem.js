...
export default function UIDailySummaryGridItem({ daySummary, units }) {
  ...
  return (
    <div className="flex items-center justify-between rounded-md py-1 px-3 dark:text-white">
      <div className="w-36">{daySummary.dayOfWeek}</div>
      <div>{getWeatherIcon(daySummary)}</div>
      <div>
